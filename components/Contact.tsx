            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  icon: <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.35 2 2 0 0 1 3.6 1h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 8.91a16 16 0 0 0 6 6l.76-.76a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>,
                },
                {
                  accent: 'accent',
                  label: 'Email',
                  value: 'hello@nexcorp.id',
                  icon: <><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></>,
                },
              ].map(item => (
                <div key={item.label} className="flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-xl bg-${item.accent}/10 flex items-center justify-center flex-shrink-0`}>
                    <svg xmlns="http://www.w3.org/2000/svg" className={`w-6 h-6 text-${item.accent}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                      {item.icon}
                      {item.icon2}
                    </svg>
                  </div>
                  <div>
                    <p className="font-semibold font-display">{item.label}</p>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="form-control">
                    ...
                    <input type="text" placeholder="Budi Santoso" className="input input-bordered rounded-xl" />
                  </div>
                  <div className="form-control">
                    ...
                    <input type="text" placeholder="PT. Maju Jaya" className="input input-bordered rounded-xl" />
                  </div>
                </div>
                <div className="form-control">
                  ...
                  <input type="email" placeholder="budi@perusahaan.com" className="input input-bordered rounded-xl" />
                </div>
                <div className="form-control">
                ...
                <div className="form-control">
                  ...
                  <textarea className="textarea textarea-bordered rounded-xl h-32" placeholder="Ceritakan kebutuhan proyek Anda..." />
                </div>
                <button
